...
CREATE TABLE achats_besoins (
    ...
    besoin_id int NOT NULL,
    quantite int NOT NULL,
    frais_achat_besoin_id int NOT NULL,
    date_achat DATE NOT NULL DEFAULT CURRENT_DATE,
    FOREIGN KEY (ville_id) REFERENCES villes(id),
    FOREIGN KEY (besoin_id) REFERENCES besoins(id),
    FOREIGN KEY (frais_achat_besoin_id) REFERENCES frais_achat_besoin(id)
);
...
INSERT INTO achats_besoins (ville_id, besoin_id, quantite, frais_achat_besoin_id) VALUES
(1, 1, 50, 1), -- Achat de 50 unités de riz pour Ville A
(2, 2, 30, 2), -- Achat de 30 unités de tôle pour Ville B
(3, 3, 100, 3); -- Achat de 100 unités d'argent pour Ville C
...
JOIN frais_achat_besoin f ON a.frais_achat_besoin_id = f.id);
