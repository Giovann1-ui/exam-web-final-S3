...
class TypeBesoinController {
    ...
    public function all_type_besoins(){
        ...
        Flight::render('saisie_don', ['type_besoins' => $type_besoins, 'csp_nonce' => Flight::get('csp_nonce'), 'base_url' => Flight::get('flight.base_url')]);
    }
    ...
    public function besoin($id){
        ...
        Flight::render('type-besoin', ['type_besoin' => $type_besoin, 'csp_nonce' => Flight::get('csp_nonce'), 'base_url' => Flight::get('flight.base_url')]);
    }
}
?>